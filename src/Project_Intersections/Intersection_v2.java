...
public class Intersection_v2 {
    public static void main(String[] args) {
        ...
        // This will accept from Connection Street
        ...
        OP1.SetName("OP1");
        OP1.Value = new TransferOperation("localhost", "1094", "in1");
        ...
        OP2.SetName("OP2");
        OP2.Value = new TransferOperation("localhost", "1094", "in2");
        ...
        OP3.SetName("OP3");
        OP3.Value = new TransferOperation("localhost", "1094", "in3");
